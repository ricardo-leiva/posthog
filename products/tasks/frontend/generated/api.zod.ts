 ...
 */
export const TasksActivateWarmCreateBody = /* @__PURE__ */ zod
    .object({
        run_id: zod.uuid().describe('Id of the warm Run to activate (as returned by `warm`).'),
        task_id: zod.uuid().describe("Id of the warm Run's draft Task (as returned by `warm`)."),
        message: zod
            .string()
            .describe(
    ...
    .describe('Request body for activating an idling warm Run on submit — forwards the typed message to the agent.')
 ...
 */
export const TasksReleaseWarmCreateBody = /* @__PURE__ */ zod
    .object({
        run_id: zod.uuid().describe('Id of the warm Run to release (as returned by `warm`).'),
        task_id: zod.uuid().describe("Id of the warm Run's draft Task (as returned by `warm`)."),
    })
    .describe('Request body for releasing an unactivated warm Run the user abandoned (or re-keyed).')
